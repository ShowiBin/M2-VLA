...
class ModelConfig(ChoiceRegistry):
    ...
    align_epochs: int
    align_max_steps: Optional[int]
    align_save_every_n_steps: Optional[int]
    align_global_batch_size: int
    align_per_device_batch_size: int
    align_learning_rate: float
    align_weight_decay: float
    align_max_grad_norm: float
    align_lr_scheduler_type: str
    align_warmup_ratio: float
    align_train_strategy: str
    finetune_epochs: int
    finetune_max_steps: Optional[int]
    finetune_save_every_n_steps: Optional[int]
    finetune_global_batch_size: int
    finetune_per_device_batch_size: int
    finetune_learning_rate: float
    finetune_weight_decay: float
    finetune_max_grad_norm: float
    finetune_lr_scheduler_type: str
    finetune_warmup_ratio: float
    finetune_train_strategy: str
...
class LLaVa_v15_Reproduction_7B(ModelConfig):
    ...
    align_learning_rate: float = 0.001
    ...
    finetune_learning_rate: float = 2e-05
