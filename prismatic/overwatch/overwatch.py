...
LOG_CONFIG = {'version': 1, 'disable_existing_loggers': True, 'formatters': {'simple-console': {'format': RICH_FORMATTER, 'datefmt': DATEFMT}}, 'handlers': {'console': {'class': 'rich.logging.RichHandler', 'formatter': 'simple-console', 'markup': True, 'rich_tracebacks': True, 'show_level': True, 'show_path': True, 'show_time': True}}, 'root': {'level': 'INFO', 'handlers': ['console']}}
